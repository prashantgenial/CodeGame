...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.toLowerCase()+" "+ str.toUpperCase());	//printing in lowercase & uppercase
		
		System.out.println("Remove l from Hello World:"+removeChar(str,'l'));
	...
	static void print() {
		...
		//StringUtils and Guava string Utils
		static void stringExamples() {
			...
			System.out.println("s.compareTo(\"HELLO WORLD!\"): " + s.compareTo("HELLO WORLD!"));	//Not clear
